...
#endif
{
	...
	printf("vmcman: wLaunchELF patched VMC build active\n");
#endif
...
#if defined(BUILDING_VMCMAN)
	/* VMC media cannot physically change while mounted; avoid fragile re-probes. */
	if ((mcdi->cardtype == sceMcTypePS2) && (mcdi->cardform == 1))
